<x-layouts.admin :title="'Tambah Meja Baru'">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <a href="{{ route('admin.tables.index') }}"
                class="inline-flex items-center gap-2 text-sm hover:opacity-80 transition-opacity whitespace-nowrap"
                style="color: #D4A574;">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="#D4A574" viewBox="0 0 24 24"
        ...
        <div class="rounded-xl p-6" style="background-color: #2b211e; border: 1px solid #3e302b;">
            <h2 class="text-xl font-bold mb-6" style="color: #f0f2bd;">Tambah Meja Baru</h2>
            ...
            <form action="{{ route('admin.tables.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="table_number" id="table_number" value="{{ old('table_number') }}"
                        ...
                        style="background-color: #3e302b; color: #f0f2bd;" placeholder="Contoh: A1, T01, VIP1" required>
                    @error('table_number')
